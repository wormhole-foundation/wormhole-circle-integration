...
// Base Goerli
uint256 constant BASE_EVM_CHAIN_ID = 84531;
...
bytes32 constant BASE_EMITTER = bytes32(uint256(uint160(address(0x2703483B1a5a7c577e8680de9Df8Be03c6f30e3c))));
...
contract CircleIntegrationImplementation is CircleIntegration {
    function initialize() public virtual initializer {
        ...
        if (block.chainid != BASE_EVM_CHAIN_ID) {
            setEmitter(BASE_CHAIN_ID, BASE_EMITTER);
            setChainIdToDomain(BASE_CHAIN_ID, BASE_DOMAIN);
            setDomainToChainId(BASE_DOMAIN, BASE_CHAIN_ID);
        }
    }
